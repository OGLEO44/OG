...
# Ensure these imports point to your correct database modules
...
async def filter_handler(bot, message: Message):
    """
    Handles incoming text messages (excluding commands) in private, group, and supergroup chats.
    """
    ...
    if force_sub and chat_type == ChatType.PRIVATE:
        try:
